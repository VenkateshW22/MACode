...
public class UserAction extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5102694238377440064L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserAction\",\"namespace\":\"com.example.kafka.avro\",\"fields\":[{\"name\":\"userId\",\"type\":\"string\"},{\"name\":\"action\",\"type\":\"string\"},{\"name\":\"timestamp\",\"type\":\"long\",\"logicalType\":\"timestamp-millis\"}]}");
   ...
   */
  public static BinaryMessageEncoder<UserAction> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a UserAction instance decoded from the given buffer
   ...
   */
  public UserAction(java.lang.CharSequence userId, java.lang.CharSequence action, java.lang.Long timestamp) {
    this.userId = userId;
    this.action = action;
   ...
   */
  public static com.example.kafka.avro.UserAction.Builder newBuilder() {
    return new com.example.kafka.avro.UserAction.Builder();
  }
   ...
   * @return A new UserAction RecordBuilder
   */
  public static com.example.kafka.avro.UserAction.Builder newBuilder(com.example.kafka.avro.UserAction.Builder other) {
    if (other == null) {
      return new com.example.kafka.avro.UserAction.Builder();
    } else {
      return new com.example.kafka.avro.UserAction.Builder(other);
    }
  }
   ...
   * @return A new UserAction RecordBuilder
   */
  public static com.example.kafka.avro.UserAction.Builder newBuilder(com.example.kafka.avro.UserAction other) {
    if (other == null) {
      return new com.example.kafka.avro.UserAction.Builder();
    } else {
      return new com.example.kafka.avro.UserAction.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserAction>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafka.avro.UserAction.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafka.avro.UserAction other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.avro.UserAction.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.avro.UserAction.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.avro.UserAction.Builder setAction(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.avro.UserAction.Builder clearAction() {
      action = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.avro.UserAction.Builder setTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka.avro.UserAction.Builder clearTimestamp() {
